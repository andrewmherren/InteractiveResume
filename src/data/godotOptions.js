export const GODOT_OPTIONS = [
    ...
    {
        zone: 'Zone2',
        actionData: 'acquisition',
        label: 'Acquisition',
        title: 'Post-Acquisition Integration',
        summary:
            'Led integration of Xtract platform into ModMed while keeping customer workflows stable and the team productive.',
        bullets: [
    ...
    },
    {
        ...
        label: 'Diagnostics',
        title: 'Field Diagnostics and RCA',
        summary:
            'Built lightweight telemetry tools to capture rare failures and unlock root-cause analysis in the field.',
        bullets: [
