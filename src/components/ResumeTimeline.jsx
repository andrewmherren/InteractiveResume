    ...
    const experiences = [
        {
            ...
            summary: "Integrated and extended Xtract's healthcare allergy platform post-acquisition across AWS infrastructure (ECS, RDS, CloudWatch). Architected solutions for seamless legacy system integration into enterprise environment while maintaining HIPAA compliance.",
            example: "[TBD]"
        },
        {
            id: 2,
        ...
        },
        {
            ...
            summary: "Root cause analysis on flagship multifunction printer line. Diagnosed jamming issue affecting 21% of field returns and 33% of prototypes; led redesign of registration module. Deployed on-site to Southeast Asia during critical line-down event with 80% production rejection.",
            example: "[TBD]"
        },
    ];
